...
/**
 * Created by Harjot on 27-Mar-16.
 */
            ...
            case 2:
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN && !explodeCalled) {
                    if (dist < 75) {
                        ...
                        GameView.pauseVX = GameView.main.vx;
                        GameView.pauseVY = GameView.main.vy;
                        GameView.main.vx = 0;
                        GameView.main.vy = 0;
                        GameView.gameState = 3;
                        break;
                    }
            ...
            case 3:
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    if (distance_resume < 200) {
                        ...
                        GameView.main.vx = GameView.pauseVX;
                        GameView.main.vy = GameView.pauseVY;
                        GameView.pauseVX = 0;
                        GameView.pauseVY = 0;
                        playPaint.setAlpha(248);
                        gameState = 2;
